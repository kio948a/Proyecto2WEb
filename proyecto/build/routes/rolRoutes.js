...
class RolRoutes {
    ...
    config() {
        ...
        this.router.post('/create', auth_1.validarToken, rolController_1.rolController.create);
        ...
        this.router.get('/showAll/', auth_1.validarToken, rolController_1.rolController.list);
