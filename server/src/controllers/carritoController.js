...
class CarritoController {
    ...
    listCarritoUsuario(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query(`SELECT carrito.*, user.nombre as nombreUsuario FROM  carrito LEFT JOIN user on carrito.id_usuario = user.id WHERE carrito.id_usuario = ?;`, id);
            if (resp.length > 0) {
                res.json(resp);
                return;
            }
